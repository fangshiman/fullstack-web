...
- Ensure that proxy in the ```client/package.json``` is set to "http://backend:5003" on line 40
...
- Go into ```client/package.json``` and change proxy to "http://localhost:5003" on line 40
